...
namespace gfx
{
	...
	public:
		...
		/// <summary>
		/// Add each element in sequential order to the waiting queue
		/// </summary>
		/// <param name="locations of the chunks"></param>
		void add_cmesh(const std::list<types::chunk_loc>& clocs) noexcept
		{
			m_waiting_cmesh.push_range(clocs);
		}
